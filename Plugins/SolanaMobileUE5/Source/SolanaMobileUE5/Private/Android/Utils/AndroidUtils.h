...
public:
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniVoidMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniStringMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniBoolMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniIntMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniLongMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniObjectMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    ...
    Env->DeleteLocalRef(Class);
    if (!Result)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniObjectArray [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    ...
    Env->DeleteLocalRef(Class);
    if (!Result)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobjectArray = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniFloatArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniIntArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallJniLongArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniVoidMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniStringMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniBoolMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniIntMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniLongMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniObjectMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    ...
    if (!Result)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: return jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniObjectArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    ...
    Env->DeleteLocalRef(Class);
    if (!Result)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: return jobjectArray = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));

    return Result;
  }
  static jfloatArray CallObjectJniFloatArrayMethod(jobject object, const ANSICHAR* MethodName, const ANSICHAR* MethodSignature, ...)
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniFloatArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniIntArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
    if (!object)
      UE_LOG(LogTemp, Error, TEXT("SolanaMobileUE5 -> Err: jobject = null  [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  {
    UE_LOG(LogTemp, Log, TEXT("SolanaMobileUE5 -> Method CallObjectJniLongArrayMethod [%s][%s]"), *FString(MethodName), *FString(MethodSignature));
  ...
  /**
  * @param ClassName - package (used by com/Plugins/SolanaMobileUE5) and the name of your Java class.
